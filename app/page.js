export default function Home() {
  return (
    <main style={{fontFamily:'Arial, sans-serif',background:'#000',color:'#fff',minHeight:'100vh',padding:'40px'}}>
      ...
      <a href="https://wa.me/918999061598?text=Hi%20AP%20Villas%20I%20want%20to%20book" style={{display:'inline-block',marginTop:'20px',padding:'12px 20px',background:'#f5c542',color:'#000',borderRadius:'12px',textDecoration:'none'}}>Book on WhatsApp</a>
